            ...
            steps {
                script {
                    try{
                        ...
                        emailext attachLog: true, mimeType: 'text/html', attachmentsPattern: 'playwright-report/index.html, playwright-report/report.txt', body: 'See attached report for failed test(s).', recipientProviders: [previous(), brokenBuildSuspects(), brokenTestsSuspects()], subject: '$PROJECT_NAME - Build # $BUILD_NUMBER - TEST FAILED!'
